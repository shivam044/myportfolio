  ...
  return (
    <div className='border-b border-lightGrey px-[6%] pb-40 text-center'>
      ...
      <h2 className='pt-6 text-xl font-semibold text-font'>
        ...
        <a href='https://github.com/shivam044' className='text-blue-500 hover:text-blue-700'>
          {' '}
          Email me
        </a>
        .
      ...
      <Button onClick={() => window.open('https://github.com/shivam044', '_blank')} filled mxAuto>
