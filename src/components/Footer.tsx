...
const Footer: React.FC = () => {
  return (
    <div className='relative flex h-screen flex-col items-center justify-center gap-10 bg-primary pt-32 md:pt-0'>
      ...
      <img src='/img/logo.png' alt='icon' className='w-16' />
      <h2 className='text-center text-lg font-normal text-white md:text-xl'>
        Handcrafted by me, <br />
      </h2>
      <div className='flex'>
        <a href='https://tailwindcss.com/'>
          <div className='text-xs@md color-contrast-medium gap-xs flex flex-wrap gap-x-2 gap-x-2 text-sm'>
            <p>Made with</p>
            <div>
              <svg
                viewBox='0 0 248 31'
                className='mx-auto h-4 w-auto text-slate-900 dark:text-white'
              >
                <path
